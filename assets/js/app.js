...
let request=document.getElementById(`countrycontainer`);

result=" ";

countries.forEach(function(para , i){
  result += `<div class="col-sm-3 colheight">
  <div class="card mb-4">
      <h4 class="card-header text-center text-black bg-info">
        country no : ${i+1}
      </h4>
      <div class="card-body">
          <div class="flag">
